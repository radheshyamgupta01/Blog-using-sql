...
//         class="bg-white rounded-lg shadow-lg p-8 w-96"
//       >
//         <div class="mb-4">
...
export default function Blog() {
  ...
  return (
    <div className="flex-col  ">
      ...
      >
<h1 className="bg-white text-center font-semibold text-2xl" >
  Blog
</h1>

        <div className="mb-4 flex- justify-between">
          <label className="font-semibold mb-2 block text-title-case">
            Blog title
          </label>
          <input
            type="text"
        ...
        <div className="mb-6">
          <label
            htmlFor="support"
            className="font-semibold mb-2 block text-title-case"
          >
            Blog Content
          </label>
          <textarea
